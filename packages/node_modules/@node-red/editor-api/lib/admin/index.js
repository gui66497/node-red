...
module.exports = {
    init: function(runtimeAPI) {
        ...
        adminApp.get("/generateConfig/:id",needsPermission("flows.read"),flow.generate,apiUtil.errorHandler);
        adminApp.get("/getMatchRules",needsPermission("flows.read"),flow.getRule,apiUtil.errorHandler);
